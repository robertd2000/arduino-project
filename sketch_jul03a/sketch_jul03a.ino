/*
  ...
  Система использует аппаратные прерывания
*/
...
#define sensVCC 2       // питание сенсора
#define servoVCC 3      // питание серво
...
void setup() {
  ...
  servo.attach(servoVCC);

  // настраиваем пины питания как выходы
 // pinMode(buzzPin, OUTPUT);
 // pinMode(buzzGND, OUTPUT);
  pinMode(sensGND, OUTPUT);
  pinMode(sensVCC, OUTPUT); // сенсорная кнопка почему то как выход а вход может нужно исправить
